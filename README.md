...
<p align="center">
<svg viewBox="0 0 960 760" width="960" height="760" xmlns="http://www.w3.org/2000/svg">
  <rect width="100%" height="100%" fill="#f0f6fb"/>
  <defs>
    <style>
      .ind  { font: 600 11px 'Segoe UI',sans-serif; fill:#1a2e3b; }
      .sub  { font: 400  9px 'Segoe UI',sans-serif; fill:#4a6f8a; }
      .eye  { font: 500  7px 'Courier New',monospace; fill:#7a9db5; letter-spacing:.1em; }
    </style>
  </defs>

  <!-- ── Centre node ── -->
  <rect x="400" y="330" width="160" height="60" rx="8"
        fill="rgba(30,144,214,0.10)" stroke="#1e90d6" stroke-width="1.5"/>
  <text x="480" y="355" class="ind" text-anchor="middle" font-size="13">AI Agents</text>
  <text x="480" y="372" class="sub" text-anchor="middle">Industry Use Cases</text>

  <!-- ════════════════════════════════════════════
       LEFT COLUMN  (8 industries, top→bottom)
  ════════════════════════════════════════════ -->

  <!-- 1. Healthcare  y=60 -->
  <line x1="400" y1="355" x2="228" y2="75"  stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="52"  width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="57" width="52"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="134" y="66"  class="eye" text-anchor="middle">HEALTHCARE</text>
  <text x="164" y="80"  class="ind" text-anchor="middle">Healthcare</text>
  <text x="164" y="92"  class="sub" text-anchor="middle">diagnostics · insights</text>

  <!-- 2. Finance  y=130 -->
  <line x1="400" y1="350" x2="228" y2="145" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="122" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="127" width="40"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="128" y="136" class="eye" text-anchor="middle">FINANCE</text>
  <text x="164" y="150" class="ind" text-anchor="middle">Finance</text>
  <text x="164" y="162" class="sub" text-anchor="middle">trading · fraud · advising</text>

  <!-- 3. Education  y=200 -->
  <line x1="400" y1="348" x2="228" y2="215" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="192" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="197" width="48"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="132" y="206" class="eye" text-anchor="middle">EDUCATION</text>
  <text x="164" y="220" class="ind" text-anchor="middle">Education</text>
  <text x="164" y="232" class="sub" text-anchor="middle">tutors · learning paths</text>

  <!-- 4. Customer Service  y=270 -->
  <line x1="400" y1="348" x2="228" y2="285" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="262" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="267" width="60"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="138" y="276" class="eye" text-anchor="middle">CUSTOMER SVC</text>
  <text x="164" y="290" class="ind" text-anchor="middle">Customer Service</text>
  <text x="164" y="302" class="sub" text-anchor="middle">24/7 chatbots · support</text>

  <!-- 5. Retail  y=340 -->
  <line x1="400" y1="360" x2="228" y2="355" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="332" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="337" width="32"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="124" y="346" class="eye" text-anchor="middle">RETAIL</text>
  <text x="164" y="360" class="ind" text-anchor="middle">Retail</text>
  <text x="164" y="372" class="sub" text-anchor="middle">recommendations · pricing</text>

  <!-- 6. Transportation  y=410 -->
  <line x1="400" y1="370" x2="228" y2="425" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="402" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="407" width="68"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="142" y="416" class="eye" text-anchor="middle">TRANSPORTATION</text>
  <text x="164" y="430" class="ind" text-anchor="middle">Transportation</text>
  <text x="164" y="442" class="sub" text-anchor="middle">routing · delivery agents</text>

  <!-- 7. Manufacturing  y=480 -->
  <line x1="400" y1="375" x2="228" y2="495" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="472" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="477" width="64"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="140" y="486" class="eye" text-anchor="middle">MANUFACTURING</text>
  <text x="164" y="500" class="ind" text-anchor="middle">Manufacturing</text>
  <text x="164" y="512" class="sub" text-anchor="middle">monitoring · quality ctrl</text>

  <!-- 8. Real Estate  y=550 -->
  <line x1="400" y1="378" x2="228" y2="565" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="100" y="542" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="108" y="547" width="56"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="136" y="556" class="eye" text-anchor="middle">REAL ESTATE</text>
  <text x="164" y="570" class="ind" text-anchor="middle">Real Estate</text>
  <text x="164" y="582" class="sub" text-anchor="middle">pricing · virtual tours</text>

  <!-- ════════════════════════════════════════════
       RIGHT COLUMN  (8 industries, top→bottom)
  ════════════════════════════════════════════ -->

  <!-- 9. Agriculture  y=60 -->
  <line x1="560" y1="355" x2="732" y2="75"  stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="52"  width="128" height="46" rx="6" fill="rgba(30,144,214,0.06)" stroke="#1e90d6" stroke-width="1.2"/>
  <rect x="740" y="57" width="56"  height="11" rx="2" fill="transparent" stroke="rgba(30,144,214,.4)" stroke-width=".8"/>
  <text x="768" y="66"  class="eye" text-anchor="middle" fill="#1e90d6">AGRICULTURE</text>
  <text x="796" y="80"  class="ind" text-anchor="middle">Agriculture</text>
  <text x="796" y="92"  class="sub" text-anchor="middle">farming · crop monitoring</text>

  <!-- 10. Energy  y=130 -->
  <line x1="560" y1="350" x2="732" y2="145" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="122" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="127" width="36"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="758" y="136" class="eye" text-anchor="middle">ENERGY</text>
  <text x="796" y="150" class="ind" text-anchor="middle">Energy</text>
  <text x="796" y="162" class="sub" text-anchor="middle">grid mgmt · forecasting</text>

  <!-- 11. Entertainment  y=200 -->
  <line x1="560" y1="348" x2="732" y2="215" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="192" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="197" width="64"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="772" y="206" class="eye" text-anchor="middle">ENTERTAINMENT</text>
  <text x="796" y="220" class="ind" text-anchor="middle">Entertainment</text>
  <text x="796" y="232" class="sub" text-anchor="middle">content · personalization</text>

  <!-- 12. Legal  y=270 -->
  <line x1="560" y1="348" x2="732" y2="285" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="262" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="267" width="32"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="756" y="276" class="eye" text-anchor="middle">LEGAL</text>
  <text x="796" y="290" class="ind" text-anchor="middle">Legal</text>
  <text x="796" y="302" class="sub" text-anchor="middle">doc review · contracts</text>

  <!-- 13. Human Resources  y=340 -->
  <line x1="560" y1="360" x2="732" y2="355" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="332" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="337" width="24"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="752" y="346" class="eye" text-anchor="middle">HR</text>
  <text x="796" y="360" class="ind" text-anchor="middle">Human Resources</text>
  <text x="796" y="372" class="sub" text-anchor="middle">recruiting · workforce</text>

  <!-- 14. Hospitality  y=410 -->
  <line x1="560" y1="370" x2="732" y2="425" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="402" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="407" width="56"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="768" y="416" class="eye" text-anchor="middle">HOSPITALITY</text>
  <text x="796" y="430" class="ind" text-anchor="middle">Hospitality</text>
  <text x="796" y="442" class="sub" text-anchor="middle">travel · booking agents</text>

  <!-- 15. Gaming  y=480 -->
  <line x1="560" y1="375" x2="732" y2="495" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="472" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="477" width="36"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="758" y="486" class="eye" text-anchor="middle">GAMING</text>
  <text x="796" y="500" class="ind" text-anchor="middle">Gaming</text>
  <text x="796" y="512" class="sub" text-anchor="middle">NPC · companion · design</text>

  <!-- 16. Cybersecurity  y=550 -->
  <line x1="560" y1="378" x2="732" y2="565" stroke="#4a6f8a" stroke-width="1"/>
  <rect x="732" y="542" width="128" height="46" rx="6" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <rect x="740" y="547" width="68"  height="11" rx="2" fill="transparent" stroke="rgba(26,46,59,.3)" stroke-width=".8"/>
  <text x="774" y="556" class="eye" text-anchor="middle">CYBERSECURITY</text>
  <text x="796" y="570" class="ind" text-anchor="middle">Cybersecurity</text>
  <text x="796" y="582" class="sub" text-anchor="middle">threat detection · red team</text>

  <!-- ── Legend strip ── -->
  <line x1="40" y1="730" x2="920" y2="730" stroke="rgba(26,46,59,0.10)" stroke-width="0.8"/>
  <rect x="44" y="736" width="12" height="12" rx="2" fill="rgba(30,144,214,0.08)" stroke="#1e90d6" stroke-width="1"/>
  <text x="62" y="745" class="eye">FOCAL INDUSTRY</text>
  <rect x="172" y="736" width="12" height="12" rx="2" fill="#fff" stroke="#1a2e3b" stroke-width="1"/>
  <text x="190" y="745" class="eye">INDUSTRY NODE</text>
  <rect x="300" y="736" width="12" height="12" rx="2" fill="rgba(30,144,214,0.10)" stroke="#1e90d6" stroke-width="1.5"/>
  <text x="318" y="745" class="eye">AI AGENTS HUB</text>
  <text x="620" y="745" class="eye">16 INDUSTRIES · AI AGENT PLAYBOOK · MAHIP KAKAN</text>
</svg>
</p>
